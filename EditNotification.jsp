												...
												<tr>
													<td height="594" valign="top">
														<form name="notification" method = "post"
															action="Notifications.do?action=update">
															<input type="hidden" name="notificationID"
																value="<%=request.getParameter("id")%>" />
															<%
																Notification_Details aNotification = (Notification_Details) session.getAttribute("load_notification");
															%>
																...
																<tr>
																	<td width="357"><table width="394" height="355"
																						...
																						name="companyID" id="select">
																							<%
																								try
																								{
																									...
																									{
																										select = "";
																										notificationID = ((Integer) enu.nextElement()).intValue();
																										if (notificationID == aNotification.getCompanyID())
																										{
																											select = "selected";
																										}
																							%>
																							<option value="<%=(notificationID)%>" <%=select%>><%=((Company_Details) cHashtable.get(new Integer(notificationID))).getCompanyName()%></option>
																							<%
																								}
																								}
																								catch (Exception e)
																			...
																			<tr>
																				...
																				<td><label> <input type="text"
																						name="location"
																						value="<%=aNotification.getLocation()%> ">
																				</label></td>
																			</tr>
																			<tr>
																				<td height="27" class="style36"><span
																			...
																			<tr>
																				...
																				<td><label> <input type="text"
																						...
																						value="<%=DateWrapper.parseDate(aNotification.getCreateddate())%>">
																						<a
																						href="javascript:show_calendar('document.notification.cdate', document.notification.cdate.value);">
																			...
																			<tr>
																				...
																				<td><label> <input type="text"
																						...
																						value="<%=DateWrapper.parseDate(aNotification.getExpirydate())%>">
																						<a
																						href="javascript:show_calendar('document.notification.expdate', document.notification.expdate.value);">
																							<img src="images/cal.gif" alt="f" width="18"
																							height="18" border="0" />
																					</a>
																				</label></td>
																			...
																			<tr>
																				...
																				<td><label> <select name="status">
																							...
																							<option>Completed</option></label></td>
																			</tr>
