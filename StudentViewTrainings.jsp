											...
											<table width="743" border="0" align="center">
												...
												<tr>
													<td height="232" valign="top"><form name="f"
															method="post" action="DeleteTrainingAction.jsp">
															<%
																...
																try
																{
																	...
																	cHashtable = aTrainingdao.getTrainings();
																	session.setAttribute("trainings", cHashtable);
																	if (!cHashtable.isEmpty())
																	{
																		System.out.println("----"+cHashtable.get(1));
															%>
															<table width="86%" border="0" align="center">
																<tr>
																	<td width="148" bgcolor="#FF9600"><div
																			align="center">
																			<strong>Name</strong>
																		</div></td>
																	<td width="156" bgcolor="#FF9600"><div
																			align="center">
																	...
																	<td width="124" bgcolor="#FF9600"><div
																			align="center">
																	...
																	<td width="164" bgcolor="#FF9600"><div
																			align="center">
																...
																<%
																	Enumeration enu = cHashtable.elements();
																			...
																			while (enu.hasMoreElements())
																			{
																				...
																				//System.out.println("TrainingId : "+training.getTrainingid());
																				//System.out.println("TrainingName : "+training.getTrainingName());
																				//System.out.println("TrainingStartDate : "+training.getTrainingStartDate());
																%>
																<tr>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><a
																				href="ViewTraining.jsp?id=<%=(training.getTraining_name())%>"
																				target="_blank"><%=(training.getTraining_name())%></a></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(DateWrapper.parseDate(training.getTrainingStartDate1()))%></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(DateWrapper.parseDate(training.getTrainingEndDate1()))%></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(training.getTrainingStartTime())%></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(training.getTrainingEndTime())%></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(training.getStatus())%></span>
																		</div></td>
																</tr>
																<%
																	}
