											...
											<table width="743" border="0" align="center">
												<tr>
													<td width="737" height="42"><div align="center"
															class="style36 style39">
															<strong>Assigned Notifications</strong>
														</div></td>
												</tr>
												<tr>
													<td height="232" valign="top"><form name="f"
															method="post" action="DeleteNotificationAction.jsp">
															<%
																...
																try
																{
																	...
																	cHashtable = aNotificationdao.getNotifications((String) session.getAttribute("user"));
																...
																<tr>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><a target="_blank"
																				href="StudentViewNotification.jsp?id=<%=(notification.getNotificationID())%>"><%=(notification.getNotificationID())%>
																			</a></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><a target="_blank"
																	...
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(DateWrapper.parseDate(notification.getCreateddate1()))%></span>
																		</div></td>
																	<td bgcolor="#FFB76F"><div align="center">
																			<span class="style38"><%=(notification.getStatus())%></span>
																		</div></td>
																</tr>
																<%
																	}
