											...
											<table width="743" border="0" align="center">
												...
												<tr>
													<td height="594" valign="top">
														<form name="notification" action="UpdateCompanyAction.jsp"
															onSubmit="return validate()">
															<input type="hidden" name="cid"
																value="<%=request.getParameter("id")%>" />
															<%
																Hashtable tHashtable = (Hashtable) session.getAttribute("companies");

																Company aCompany = (Company) tHashtable.get(new Integer(request.getParameter("id")));
															%>
																	...
																	<td width="357"><table width="394" height="326"
																			...
																			<tr>
																				<td height="51" colspan="2">
																					<div align="center">
																						<input name="Input" type="button" value="Close"
