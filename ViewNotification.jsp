...
$(function () {
    $("#list").jqGrid({
        url: "reports.jsp?type=notifications",
        datatype: "json",
        mtype: "GET",
        colNames: ["Notification ID", "Company Name", "Date", "Status", "Edit", "Delete"],
        colModel: [
            { name: "Notifocation ID", align: "left",sortable: true },
            { name: "Company Name", align: "left",sortable: true},
            { name: "Date", align: "left",sortable: true },
            { name: "Status", align: "left",sortable: true },
        ...
        width: '776',
		loadonce: true,
        caption: "Notifications Information"
    }); 
}); 
</script>
			...
			<tbody>
				...
				<tr>
					<td style="width: 30px;" align="center" valign="bottom"
										width="30"><a href="javascript:location.href='Notifications.do?action=add_new'"><img style="width: 20px; height: 20px;" alt=""
