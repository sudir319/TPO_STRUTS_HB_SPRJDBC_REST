												...
												<tr>
													<td height="232" valign="top">
														...
														<form name="newtraining" method="post"
															action="UpdateTrainingAction.jsp">
															<input type="hidden" name="tid"
																value="<%=request.getParameter("id")%>" />
															<%
																Hashtable tHashtable = (Hashtable) session.getAttribute("trainings");

																Training aTraining = (Training) tHashtable.get(new Integer(request.getParameter("id")));
															%>
															<table width="328" border="0" align="center">
																<tr>
																	<td width="114"><span class="style40"><nobr>Tarining
																				Name</span></td>
																	<td width="204"><label> <input
																			name="tname" type="text" id="tname" size="31"
																			readonly value="<%=aTraining.getTraining_name()%>">
																	</label></td>
																</tr>
																<tr>
																	<td><span class="style40">Start Date</span></td>
																	<td><label> <input name="tdate"
																			type="text" id="textfield2" size="31" readonly
																			value=<%=DateWrapper.parseDate(aTraining.getTrainingStartDate1())%>>
																	</label></td>
																</tr>
																<tr>
																	...
																	<td><label> <input name="tdate"
																			type="text" id="textfield2" size="31" readonly
																			value=<%=DateWrapper.parseDate(aTraining.getTrainingEndDate1())%>>
																	</label></td>
																</tr>
																<tr>
																	<td><span class="style40">Start Time</span></td>
																	<td><label> <input name="ttime"
																			type="text" id="ttime" size="31" readonly
																			value="<%=aTraining.getTrainingStartTime()%>">
																	</label></td>
																</tr>
																<td><span class="style40">End Time</span></td>
																<td><label> <input name="ttime" type="text"
																		id="ttime" size="31" readonly
																		value="<%=aTraining.getTrainingEndTime()%>">
																</label></td>
																</tr>
																<tr>
																	<td><span class="style40">Description</span></td>
																	<td><label> <textarea name="tdesc"
																				id="tdesc" cols="23" rows="5" readonly><%=aTraining.getDescription()%></textarea>
																	</label></td>
																</tr>
																<tr>
