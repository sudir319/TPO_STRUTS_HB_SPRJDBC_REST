													...
													<form name="acadamicreg" action="UpdateSkillAction.jsp">
														...
														<%
															try
															{
																...
																Hashtable tHashtable = new SkillDAO().getSkills(username);
														...
														<table width="528" border="0" align="center"
															...
															<tr>
																<td width="522" valign="top"><table width="468"
																		...
																		<tr>
																			...
																			<td><label> <textarea
																						...
																						rows="5"><%=aSkill.getDescription()%></textarea>
																			</label></td>
																			<td width="76" class="style36"><label> <select
																		...
																		<tr>
																			<td colspan="7"><div align="center">
																					<br> <input type="button" value="Add New"
																						onclick="javascript:location.href='StudentSkills.jsp'" />&nbsp;
